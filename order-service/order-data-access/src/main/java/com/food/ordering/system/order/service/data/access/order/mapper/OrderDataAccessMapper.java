...
public class OrderDataAccessMapper {
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity) {
        return Order.Builder.builder()
                ...
                .deliveryAddress(addressEntityToDeliverAddress(orderEntity.getAddress()))
    ...
    private List<OrderItem> orderItemEntitesToOrderItems(List<OrderItemEntity> items) {
        return items.stream()
                .map(orderItemEntity -> OrderItem.Builder.builder()
                            ...
                            .product(new Product(new ProductId(orderItemEntity.getProdductId())))
    ...
    private StreetAddress addressEntityToDeliverAddress(OrderAddressEntity address) {
        return new StreetAddress(address.getId(), address.getStreet(), address.getCity(), address.getZipCode());
    }
    ...
    private List<OrderItemEntity> orderItemsToItemEntities(List<OrderItem> items) {
        return items.stream()
                .map(orderItem -> OrderItemEntity.builder()
                        ...
                        .prodductId(orderItem.getProduct().getId().getValue())
