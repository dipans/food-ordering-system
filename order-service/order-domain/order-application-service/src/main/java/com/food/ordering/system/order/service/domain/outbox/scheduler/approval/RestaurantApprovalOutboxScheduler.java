...
import com.food.ordering.system.order.service.domain.ports.output.message.publisher.retaurantapproval.RestaurantApprovalRequestMessagePublisher;
...
public class RestaurantApprovalOutboxScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        Optional<List<OrderApprovalOutboxMessage>> outboxMessageResponse =
                approvalOutboxHelper.getApprovalOutboxMessageByOutboxStatusAndSagaSataus(
